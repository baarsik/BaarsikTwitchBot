...
- Credentials configuration window
- Song request command: !when
### Changed
- Updated YouTube and Twitch frameworks
### Fixed
- New 'Video unplayable' crash on song requests from YouTube
